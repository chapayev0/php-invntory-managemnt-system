            ...
            <td width="850" align="center"><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <ul id="MenuBar1" class="MenuBarHorizontal" >
                  <li><a href="../user/bill.php">HOME<br />
                  </a></li>
...
<li><a href="#" class="MenuBarItemSubmenu">CUSTOMER <br />
  ...
  <ul>
    <li><a href="../user/customer.php">ADD</a></li>
    <li><a href="../user/view_customer.php">VIEW</a></li>
  </ul>

<li><a href="#" class="MenuBarItemSubmenu">BILL <br />
</a>
  <ul>
    <li><a href="../user/bill.php">ADD</a></li>
    <li><a href="../user/view_bill.php">VIEW</a></li>
