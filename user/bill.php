          ...
          <div id="cus_div" align="center"></div>
                  ...
                  <table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td width="229" align="center" class="tbl_header_right"> Code</td>
                      <td width="251" align="center" class="tbl_header_right">Name</td>
                      <td width="105" align="center" class="tbl_header_right">QTY</td>
                      <td width="98" align="center" class="tbl_header_right">Unit Price</td>
                      <td width="111" align="center" class="tbl_header_right">Warranty</td>
                      <td width="59" align="center" class="tbl_header_right">Dist(%)</td>
                      <td width="101" align="center" class="tbl_header_right">Amount</td>
                    </tr>
                    <tr>
                      ...
                      <table width="971" border="0" cellspacing="0" cellpadding="0">
                        <tr class="body_text">
                          <td width="21" height="25" align="center"><img src="../images/add.png" width="16" height="16" style="cursor:pointer" onclick="gen_item('item_div_2','2');$('#count_item').val(2);"/></td>
                          <td width="248" align="left" class="border_bottom_left"><input name="item_1" type="text" class="body_text" id="item_1" size="30" onfocus="menu('item_1','price_1','name_1','war_1','qty_div_1',$('#qty_1').val
                          (),'p_no_1','qty_1');"/>                            <input name="item_id_1" type="hidden" value="" id="item_id_1"/></td>
                          <td width="252" align="right" class="border_bottom_left"><input name="name_1" type="text" class="body_text" id="name_1" size="30" onkeyup="cal_total();" style="text-align:right" onkeydown="gen_new_item(event,'item_div_2','2');"/></td>
                          <td width="96" align="right" class="border_bottom_left"><input name="qty_1" type="text" class="body_text" id="qty_1" size="10" onkeyup="cal_total();" style="text-align:right" onkeydown="gen_new_item(event,'item_div_2','2');"/></td>
                          <td width="99" align="right" class="border_bottom_left"><input name="price_1" type="text"   class="body_text" id="price_1" style="text-align:right" size="10" />                          </td>
                          <td width="107" align="right" class="border_bottom_left"><input name="war_1" type="text"   class="body_text" id="war_1" style="text-align:right" size="10" /></td>
                          <td width="54" align="right" class="border_bottom_left"><input name="discount_1" type="text" class="body_text" id="discount_1" style="text-align:right" size="4" onkeyup="cal_total();" onkeydown="gen_new_item(event,'item_div_2','2');" /></td>
                          
                          <td width="82" align="right" class="border_bottom_left_right">
                      ...
                      <tr>
                        ...
                        <td align="right">&nbsp;</td>
                        <td height="25" align="right">&nbsp;</td>
                        <td align="right"><img src="../images/add.gif" width="65" id="create" height="35" style="cursor:pointer" onclick="form_submission('create','quotation_form');"/></td>
                        <td align="right">&nbsp;</td>
                        <td height="25" align="right">&nbsp;</td>
                      </tr>
                  </table>
