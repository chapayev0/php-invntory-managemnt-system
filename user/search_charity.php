...
$rows_count=0;
$get_number_of_rows=mysqli_query($connection,$sql_count) or die("Unable to select data from the tbl_charity in count. " . mysqli_error());
...
$result_book=mysqli_query($connection,$query_book) or die("Unable to select data from the tbl_charity. ".mysqli_error());
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <?php }?>
  <tr>
    <td colspan="15"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr class="body_text">
