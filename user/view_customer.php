...
function search_other(page){
	...
	$('#other_div').load("search_charity.php",{'name':$('#name').val(),'etf':$('#etf').val(),'id':$('#id').val(),'page':page});
}
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SERACH CUSTOMERS</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="left"> <p>Shop Name</p></td>
                  <td width="20" align="center">:</td>
                  <td colspan="2" align="left"><input name="name" type="text" class="body_text" id="name" size="30" /></td>
                  <td width="20" align="center">&nbsp;</td>
                ...
                <tr class="body_text">
                  ...
                  <td align="center">&nbsp;</td>
                  <td width="100" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_other('0');"/></td>
                </tr>
              </table></td>
            </tr>
          </table>
