...
<script src="../js/mes_display.js" type="text/javascript"></script>
...
function search_books(page){
	$('#book_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#book_div').load("search_books.php",{'name':$('#name').val(),'isbn':$('#isbn').val(),'author':$('#author').val(),'category':$('#category').val(),'book_code':$('#book_code').val(),'book_no':$('#book_no').val(),'book_brw_status':$('#book_brw_status').val(),'page':page});
}
      ...
      <tr>
        ...
        <table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td height="25" colspan="6" align="left" class="page_title_text">SERACH BOOKS</td>
              </tr>
            <tr class="body_text">
              <td width="125" height="25" align="left">Book Name</td>
              <td width="20" align="center">:</td>
              <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="50" /></td>
              <td width="125" align="left">ISBN</td>
              <td width="20" align="center">:</td>
              <td width="205" align="left"><input name="isbn" type="text" class="body_text" id="isbn" size="20" /></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">Author Name</td>
              <td align="center">:</td>
              <td align="left"><input name="author" type="text" class="body_text" id="author" size="35" /></td>
              <td align="left">Category</td>
              <td align="center">:</td>
              <td align="left"><input name="category" type="text" class="body_text" id="category" size="35" /></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">Book No</td>
              <td align="center">:</td>
              <td align="left"><input name="book_no" type="text" class="body_text" id="book_no" size="25" /></td>
              <td align="left">Book ID</td>
              <td align="center">:</td>
              <td align="left"><input name="book_code" type="text" class="body_text" id="book_code" size="25" /></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">Book Status</td>
              <td align="center">:</td>
              <td align="left">
              <select name="book_brw_status" class="body_text" id="book_brw_status">
            ...
            <tr class="body_text">
              ...
              <td align="left">&nbsp;</td>
              <td align="center">&nbsp;</td>
              <td align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_books('0');"/></td>
            </tr>
          </table>
          </td>
          </tr>
          </table>
          <div id="helpdiv" class="red_text" align="center"><?php if(isset($_SESSION['book_del_mes'])){echo $_SESSION['book_del_mes'];}?><?php if(isset($_SESSION['book_up_mes'])){echo $_SESSION['book_up_mes'];}?></div>
        <br />
        <div id="book_div" align="center"></div>
...
require_once '../library/close.php';
unset($_SESSION['book_del_mes']);
unset($_SESSION['book_up_mes']);
?>