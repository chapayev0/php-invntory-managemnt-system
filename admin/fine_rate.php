...
function fine_rate_validation(){
	with(document.fine_form){
		valid=true;
		if(fine_rate.value == ""){
			valid=false;
			alert("Enter Fine Rate");
			fine_rate.focus();
		}
		return valid;
	}
      ...
      <tr>
		...
		?>
          ...
          <table width="275" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" colspan="3" align="left" class="page_title_text">ADD FINE RATE</td>
              </tr>
            <tr class="body_text">
              <td width="100" height="25" align="left">Fine Rate</td>
              <td width="20" align="center">:</td>
              <td width="155" align="left"><input name="fine_rate" type="text" class="body_text" id="fine_rate" /></td>
            </tr>
            <tr>
              <td height="45" align="left">&nbsp;</td>
              <td align="center">&nbsp;</td>
              <td align="left"><img src="../images/add.gif" width="65" height="35" style="cursor:pointer" id="add" onclick="form_submission('add','fine_form');"/></td>
            </tr>
          </table>
          </td>
          </tr>
          ...
          <table width="275" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" colspan="3" align="left" class="page_title_text">UPDATE  FINE RATE</td>
              </tr>
            <tr class="body_text">
              <td width="100" height="25" align="left">Fine Rate</td>
              <td width="20" align="center">:</td>
              <td width="155" align="left"><input name="fine_rate" type="text" class="body_text" id="fine_rate" value="<?php echo $row_fine[0]; ?>"/></td>
            </tr>
            <tr>
              <td height="45" align="left">&nbsp;</td>
              <td align="center">&nbsp;</td>
...
require_once '../library/close.php';
unset($_SESSION['fine_com_mes']);
unset($_SESSION['fine_up_mes']);
?>