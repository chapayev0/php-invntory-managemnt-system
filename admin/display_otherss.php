...
function search_bill(page){
	...
	$('#bill_div').load("search_otherss.php",{'type':$('#type').val(),'date':$('#date').val(),'page':page});
}
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr class="body_text">
          <td><fieldset style="border-color:#666">
            <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr class="body_text">
                <td height="25" colspan="6" align="center" class="page_title_text">SEARCH OTHERS</td>
              </tr>
              <tr class="body_text">
              ...
              <tr class="body_text">
                <td height="25" align="center">PUT/GET</td>
                <td align="center">:</td>
                <td align="left"><input name="type" type="text" class="body_text" id="type" size="15"/></td>
                <td align="center">&nbsp;</td>
                <td align="center">&nbsp;</td>
                <td width="200" align="left">&nbsp;</td>
              </tr>
              <tr class="body_text">
                <td height="25" align="center">Paid Date</td>
                <td align="center">:</td>
                <td align="left"><input name="date" type="text" class="body_text" id="date" size="15"/></td>
                <td align="left">&nbsp;</td>
                <td align="center">&nbsp;</td>
                <td width="200" align="left">&nbsp;</td>
              </tr>
              <tr class="body_text">
                ...
                <td align="center">&nbsp;</td>
                <td align="left"><img src="../images/search.gif" alt="" width="65" height="35" style="cursor:pointer" onclick="search_bill();"/></td>
                <td align="left">&nbsp;</td>
                <td align="center">&nbsp;</td>
                <td width="200" align="left">&nbsp;</td>
              </tr>
