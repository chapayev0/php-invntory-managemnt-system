      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" -->
          <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td height="25" colspan="4" align="left" class="page_title_text"><p>VIEW CUSTOMER</p></td>
            </tr>
           
            <tr class="body_text">
              <td width="280" height="25" align="left"> Name</td>
              <td width="20" align="center">:</td>
              <td width="400" align="left"><?php echo $row_book["c_name"]; ?></td>
              <td width="200" align="left">&nbsp;</td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left" valign="top">Address</td>
              <td align="center" valign="top">:</td>
              <td align="left"><textarea name="address" id="address" cols="30" rows="3"><?php echo $row_book["address"]; ?></textarea></td>
              <td align="left"></td>
            ...
            <tr class="body_text">
              ...
              <td align="center">:</td>
              <td align="left"><?php echo $row_book["section"]; ?></td>
              <td align="left">&nbsp;</td>
            </tr>
            <tr class="body_text">
              ...
              <td align="left">&nbsp;</td>
              <td rowspan="6" align="left"><?php if($row_book["st_photo_url"] != ""){?>
                <img src="<?php echo $row_book["st_photo_url"]; ?>" width="200" height="200" />
                <?php }?></td>
            </tr>
            <tr class="body_text">
              <td height="75" align="left">&nbsp;</td>
