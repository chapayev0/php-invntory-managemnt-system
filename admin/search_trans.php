...
if($_REQUEST['acc'] != ""){
	if($data == ""){
		$data=" AND acc LIKE '".$_REQUEST['acc']."%'";
	}else{
		$data .=" AND acc LIKE '".$_REQUEST['acc']."%'";
	}
}
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="235" align="center" class="tbl_header_right"> ID</td>
    <td width="235" height="25" align="center" class="tbl_header_right">Bank Name</td>
    <td width="120" align="center" class="tbl_header_right">Acc</td>
    <td width="120" align="center" class="tbl_header_right">Type</td>
  ...
  <tr class="body_text" onmouseover="this.style.backgroundColor='#E1F1D8';" onmouseout="this.style.backgroundColor='';">
    <td align="center" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_recp["t_id"]; ?></td>
    <td height="20" align="center" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_recp["name"]; ?></td>
    <td align="left" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_recp["acc"]; ?></td>
    <td align="left" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_recp["type"]; ?></td>
    <td align="left" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_recp["amt"]; ?></td>
