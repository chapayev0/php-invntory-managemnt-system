...
function search_act(page){
	...
	$('#rec_div').load("search_dailly_activity.php",{'date':$('#date').val(),'page':page});
}
          ...
          <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text"> Day Details</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="right">Date</td>
                  <td width="20" align="center">:</td>
                  <td width="150" align="left"><?php //echo date('Y-m-d')?>
                    <form id="form1" name="form1" method="post" action="">
                      <label for="date"></label>
                      <input type="text" name="date" id="date" />
                    </form></td>
                  <td width="100" align="left"><img src="../images/search.gif" alt="" width="65" height="35" style="cursor:pointer" onclick="search_act('0');"/></td>
                  <td width="20" align="center">&nbsp;</td>
