...
$rows_count=0;
$get_number_of_rows=mysqli_query($connection,$sql_count) or die("Unable to select data from the tbl_salary in count. " . mysqli_error());
...
$result_book=mysqli_query($connection,$query_book) or die("Unable to select data from the tbl_salary. ".mysqli_error());
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr class="body_text" onmouseover="this.style.backgroundColor='#E1F1D8';" onmouseout="this.style.backgroundColor='';">
    ...
    <td align="center" class="border_bottom_left"><img src="../images/view.png" width="16" height="16" style="cursor:pointer" onclick="parent.location='view_book.php?book_id=<?php echo $row_recp["s_id"]; ?>'"/></td>
    <td align="center" class="border_bottom_left"><img src="../images/edit.png" width="10" height="10" style="cursor:pointer" onclick="parent.location='edit_book.php?book_id=<?php echo $row_recp["s_id"]; ?>'"/></td>
    <td align="center" class="border_bottom_left_right"><img src="../images/delete.png" width="10" height="10" style="cursor:pointer" onclick="delete_book('<?php echo $row_recp["s_id"]; ?>');"/></td>
  </tr>
  <?php }?>
