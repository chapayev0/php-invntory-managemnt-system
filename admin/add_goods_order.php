...
mysql_query($query_insert) or die("Unable to insert data into the tbl_order. ".mysql_error());
...
for($x=1;$x<=$item_count;$x++){
	...
	if($_POST[$goods] != "" && $_POST[$goods_id] != "" && $_POST[$qty] != ""){
		...
		mysql_query($query_goods_insert) or die("Unable to insert data into the tbl_stock. ".mysql_error());
