...
$rows_count=0;
$get_number_of_rows=mysqli_query($connection,$sql_count) or die("Unable to select data from the tbl_load in count. " . mysqli_error());
...
$result_order=mysqli_query($connection,$query_order) or die("Unable to select data from the tbl_load. ".mysqli_error());
