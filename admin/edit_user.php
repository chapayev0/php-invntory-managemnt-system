...
$user_type=$_SESSION['user_type'];
	...
	$u_id=$_GET['u_id'];
	$query_book="SELECT * FROM tbl_user WHERE u_id='$u_id' AND u_status='0'";
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --> <form action="update_user.php" method="post" name="don_form" id="don_form" enctype="multipart/form-data" onsubmit="return don_validation();">
        <input name="u_id" id="u_id" type="hidden" value="<?php echo $u_id; ?>" />
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" ><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="4" align="left" class="page_title_text"><p>EDIT USER DETAILS</p>
                    <p>&nbsp;</p></td>
                </tr>
                <tr class="body_text">
                  <td width="125" height="25" align="left"> Name</td>
                  <td width="20" align="center">:</td>
                  <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="30" value="<?php echo $row_book["u_name"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">NIC</td>
                  <td align="center">:</td>
                  <td align="left"><input name="nic" type="text" class="body_text" id="nic" size="30" value="<?php echo $row_book["u_nic"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Address</td>
                  <td align="center">:</td>
                  <td align="left"><input name="address" type="text" class="body_text" id="address" size="30" value="<?php echo $row_book["u_address"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Tel</td>
                  <td align="center">:</td>
                  <td align="left"><input name="tel" type="text" class="body_text" id="tel" size="30" value="<?php echo $row_book["u_tel"]; ?>"/></td>
                </tr>
                
                <tr class="body_text">
                  <td height="25" align="left">Email</td>
                  <td align="center">:</td>
                  <td align="left"><input name="email" type="text" class="body_text" id="email" size="30" value="<?php echo $row_book["email"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">User Type</td>
                  <td align="center">:</td>
                  <td align="left"><input name="type" type="text" class="body_text" id="type" size="30" value="<?php echo $row_book["u_type"]; ?>"/></td>
                </tr>
                <tr class="body_text">
