...
function search_users(page){
	...
	$('#user_div').load("search_cheque.php",{'name':$('#name').val(),'type':$('#type').val(),'page':page});
}
...
function assign_activity_status(pay_id){
	var activity_status = "status_"+pay_id;
	var act_status = $('#'+activity_status).val();
window.location = 'update_activity_status1.php?pay_id='+pay_id+'&activity_status='+act_status;
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" colspan="3" align="left" class="page_title_text">SEARCH CHEQUE PAYMENT</td>
              </tr>
            <tr>
            ...
            <tr>
              <td height="25" align="center" class="body_text">Status</td>
              <td align="center">:</td>
