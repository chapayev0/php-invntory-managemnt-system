...
function search_users(page){
	...
	$('#user_div').load("search_payment.php",{'name':$('#name').val(),'type':$('#type').val(),'f_date':$('#f_date').val(),'t_date':$('#t_date').val(),'page':page});
}

function delete_user(pay_id){
	if(confirm("Do you want to delete this ?")){
		window.location='delete_pay.php?pay_id='+pay_id;
	}
}
</script>
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" colspan="3" align="left" class="page_title_text">SEARCH PAYMENT</td>
              </tr>
            <tr>
              <td width="125" height="25" align="center" class="body_text">Shop Name</td>
              <td width="20" align="center">:</td>
              <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="40" /></td>
            </tr>
            <tr>
              <td height="25" align="center" class="body_text">Payment Type</td>
              <td align="center">:</td>
              <td align="left"><select name="type" class="body_text" id="type">
            ...
            <tr>
              <td height="25" align="center"><span class="body_text">Date </span></td>
              <td align="center">:</td>
              <td align="left"><span class="body_text">From </span>                <input name="f_date" type="text" class="body_text" id="f_date" size="10"/>
                <span class="body_text">To 
                <input name="t_date" type="text" class="body_text" id="t_date" size="10"/>
                </span></td>
            </tr>
            <tr>
			...
			<div id="user_div" align="center"></div><!-- InstanceEndEditable --></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
