...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --> <form action="update_late_amount.php" method="post" name="don_form" id="don_form" enctype="multipart/form-data" onsubmit="return don_validation();">
        <input name="pay_id" id="pay_id" type="hidden" value="<?php echo $pay_id; ?>" />
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="rounded-corners"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="4" align="left" class="page_title_text"><p>ADD LATE CHEQUE AMOUNT </p>
                    <p>&nbsp;</p></td>
                </tr>
                <tr class="body_text">
                  <td width="125" height="25" align="left"> Pay No</td>
                  <td width="20" align="center">:</td>
                  <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="30" value="<?php echo $row_book["pay_id"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Late Amount</td>
                  <td align="center">:</td>
                  <td align="left"><input name="amt" type="text" class="body_text" id="amount" size="30" /></td>
                </tr>
                <tr class="body_text">
