...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td class="rounded-corners"><form action="add_otherss.php" method="post" name="bill_form" id="bill_form" enctype="multipart/form-data" onsubmit="return payment_validation();">
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr class="body_text">
                <td height="25" colspan="3" align="center"><div id="helpdiv" class="red_text" align="center"></div></td>
              </tr>
              <tr class="body_text">
                <td height="25" colspan="3" align="center" class="page_title_text">ADD OTHERS<br /></td>
              </tr>
              <tr class="body_text">
                <td width="125" height="35" align="center" class="TableTile">Type</td>
                <td width="20" align="center">:</td>
                <td width="255" align="left"><label for="type"></label>
              ...
              <tr class="body_text">
                <td height="35" align="center" class="TableTile">Amount</td>
                <td align="center">:</td>
                <td align="left"><input name="amount" type="text" class="body_text" id="amount" size="20" /></td>
              </tr>
              <tr class="body_text">
                <td height="35" align="center" class="TableTile">Description</td>
                <td align="center">:</td>
                <td align="left"><label for="dis"></label>
                  <textarea name="dis" id="dis" cols="30" rows="3"></textarea></td>
              </tr>
              <tr class="body_text">
                <td height="35" align="center" class="TableTile"> Date</td>
                <td align="center">:</td>
                <td align="left"><input name="date" type="text" class="body_text" id="date" size="10" onclick="function ();"/></td>
              </tr>
              <tr class="body_text">
                <td height="30" align="left">&nbsp;</td>
                <td align="center">&nbsp;</td>
                <td align="left" class="green_text"><img src="../images/add.gif" width="65" height="35" id="add" style="cursor:pointer" onclick="form_submission('add','bill_form');"/> <img src="../images/clear.gif" width="65" height="35" style="cursor:pointer" onclick="reset_form('bill_form');"/></td>
              </tr>
            </table>
          </form></td>
        </tr>
