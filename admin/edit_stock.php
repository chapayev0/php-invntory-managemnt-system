...
$user_type=$_SESSION['user_type'];
if($user_type == "admin"){
	 $query_user="SELECT * FROM tbl_stockall WHERE id='".$_GET['id']."'";
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><form action="update_stock.php" method="post" name="product_form" id="product_form" onsubmit="return product_validation();">
                    <p>
                      <input name="id1" id="id1" type="hidden" value="<?php echo $_GET['id']; ?>" />
                      ...
                      <tr class="body_text">
                        ...
                        <td align="center">&nbsp;</td>
                        <td align="left"><input name="id" type="text" class="body_text" id="id" size="25" value="<?php echo $row_user["code"]; ?>"/></td>
                      </tr>
                      <tr class="body_text">
                        <td width="125" height="25" align="left">Product Name</td>
                        <td width="20" align="center">:</td>
                        <td width="305" align="left"><input name="code" type="text" class="body_text" id="code" size="25" value="<?php echo $row_user["name"]; ?>"/></td>
                      </tr>
                      <tr class="body_text">
                        <td height="25" align="left">Qty</td>
                        <td align="center">:</td>
                        <td align="left"><input name="qty" type="text" class="body_text" id="qty" size="25" value="<?php echo $row_user["qty"]; ?>"/></td>
                      </tr>
                      <tr class="body_text">
