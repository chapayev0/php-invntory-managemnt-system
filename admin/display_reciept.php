...
function search_reciept(page){
	$('#rec_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#rec_div').load("search_reciept.php",{'name':$('#name').val(),'id':$('#id').val(),'date1':$('#date1').val(),'date2':$('#date2').val(),'fane':$('#fane').val(),'page':page});
}

function delete_rec(rec_id){
	if(confirm("Do you want to delete this record ?")){
		window.location='delete_rec.php?rec_id='+rec_id;
	}
}
...
function daily_amount(){
		...
		var date = $('#dte').val();
		$('#rec_div').load("daily_amount.php",{'date':$('#date').val()});
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" -->
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SERACH RECIEPTS</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="left"> <p>Rec ID</p></td>
                  <td width="20" align="center">:</td>
                  <td width="150" align="left"><input name="id" type="text" class="body_text" id="id" size="30" /></td>
                  <td width="200" align="center">Date&nbsp;&nbsp; : From&nbsp;&nbsp;&nbsp;
                    <input name="date1" type="text" class="body_text" id="date1" size="10" /></td>
                  <td width="20" align="center">To</td>
                  <td width="100" align="left"><input name="date2" type="text" class="body_text" id="date2" size="10" /></td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="left">Recipient Name</td>
                  <td align="center">:</td>
                  <td width="150" align="left"><input name="name" type="text" class="body_text" id="name" size="30" /></td>
                  <td width="200" align="center">Today&nbsp;&nbsp; : 
                    <input name="date" type="text" class="body_text" id="date" size="20" onchange="daily_amount();"/></td>
                  <td align="center">&nbsp;</td>
                  <td width="100" align="left">&nbsp;</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="left">Oblation</td>
                  <td align="center">:</td>
                  <td width="150" align="left"><select name="fane" class="body_text" id="fane">
                    <option value="">Select Fane </option>
                    <?php fane("");?>
                  </select></td>
                  <td width="200" align="left">&nbsp;</td>
                  <td align="center">&nbsp;</td>
                  <td width="100" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_reciept('0');"/></td>
                </tr>
              </table></td>
            </tr>
          </table>
           <div id="helpdiv" class="red_text" align="center"><?php if(isset($_SESSION['rec_del_mes'])){echo $_SESSION['rec_del_mes'];}?><?php if(isset($_SESSION['rec_up_mes'])){echo $_SESSION['rec_up_mes'];}?></div>
        <br />
        <div id="rec_div" align="center"></div>
...
require_once '../library/close.php';
unset($_SESSION['rec_del_mes']);
unset($_SESSION['rec_up_mes']);
?>