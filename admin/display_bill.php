...
function search_bill(page){
	...
	$('#bill_div').load("search_bill.php",{'name':$('#name').val(),'no':$('#no').val(),'bill_type':$('#bill_type').val(),'date':$('#date').val(),'page':page});
}

function delete_book(bill_id){
	if(confirm("Do you want to delete this record ?")){
		window.location='delete_rec.php?bill_id='+bill_id;
	}
}

function daily_amount(){
		var date = $('#dte').val();
		$('#bill_div').load("daily_amount_bill.php",{'dat':$('#dat').val()});		
}
</script>
<!-- InstanceEndEditable -->
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" -->
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td><fieldset style="border-color:#666">
                <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr class="body_text">
                  ...
                  <tr class="body_text">
                    <td height="25" colspan="6" align="left" class="page_title_text">SEARCH PAID BILLS</td>
                  </tr>
                  <tr class="body_text">
                    <td width="125" height="25" align="left">Invoice No</td>
                    <td width="20" align="center">:</td>
                    <td width="255" align="left"><input name="no" type="text" class="body_text" id="no" size="25" /></td>
                    <td width="125" align="left">Bill Type</td>
                    <td width="20" align="center">:</td>
                    <td width="200" align="left"><select name="bill_type" class="body_text" id="bill_type">
                      <option value="">Select Bill Name</option>
                      <?php puja("");?>
                    </select></td>
                  </tr>
                  <tr class="body_text">
                    <td height="25" align="left">Paid Person</td>
                    <td align="center">:</td>
                    <td align="left"><input name="name" type="text" class="body_text" id="name" size="25" /></td>
                    <td align="left">Paid Date</td>
                    <td align="center">:</td>
                    <td width="200" align="left"><input name="date" type="text" class="body_text" id="date" size="15"/></td>
                  </tr>
                  <tr class="body_text">
                    <td height="25" align="left">Today</td>
                    <td align="center">:</td>
                    <td align="left"><input name="dat" type="text" class="body_text" id="dat" size="25" onchange="daily_amount();"/></td>
                    <td align="left">&nbsp;</td>
                    <td align="center">&nbsp;</td>
                    <td width="200" align="left">&nbsp;</td>
                  </tr>
                  <tr class="body_text">
                    ...
                    <td align="left">&nbsp;</td>
                    <td align="center">&nbsp;</td>
                    <td width="200" align="left"><img src="../images/search.gif" alt="" width="65" height="35" style="cursor:pointer" onclick="search_bill();"/></td>
                  </tr>
                </table>
              </fieldset></td>
            </tr>
          ...
          <div id="helpdiv" class="red_text" align="center">
            <?php if(isset($_SESSION['emp_up_mes'])){echo $_SESSION['emp_up_mes'];}?>
            <?php if(isset($_SESSION['emp_del_mes'])){echo $_SESSION['emp_del_mes'];}?>
          </div>
          <br />
        <div id="bill_div" align="center"></div>
