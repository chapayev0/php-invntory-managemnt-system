...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="150" align="center" class="tbl_header_right">Email</td>
  ...
  <tr class="body_text" onmouseover="this.style.backgroundColor='#DCF8FC';" onmouseout="this.style.backgroundColor='';">
    ...
    <td width="150" align="left" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_user["email"]; ?></td>
    ...
    <td width="50" align="center" class="border_top_bottom_left" style="padding-left:3pt;"><img src="../images/edit.png" width="10" height="10" style="cursor:pointer" onclick="parent.location='edit_user.php?u_id=<?php echo $row_user["u_id"]; ?>'"/></td>
    <td width="50" align="center" class="border_top_bottom_left_right" style="padding-left:3pt;"><img src="../images/delete.png" alt="" width="10" height="10" style="cursor:pointer" onclick="delete_user('<?php echo $row_user["u_id"]; ?>');"/></td>
    
  </tr>
  <?php }?>
  <tr>
    <td height="20" colspan="10"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr class="body_text">
