...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><form action="update_qty.php" method="post" name="don_form" id="don_form" enctype="multipart/form-data" onsubmit="return don_validation();">
        <input name="ld_item_id" id="ld_item_id" type="hidden" value="<?php echo $ld_item_id; ?>" />
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" ><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="4" align="left" class="page_title_text"><p>Selling Qty</p></td>
                </tr>
                <tr class="body_text">
                  <td width="125" height="25" align="left">Item Code</td>
                  <td width="20" align="center">:</td>
                  <td width="255" align="left"><input name="id" type="text" class="body_text" id="id" size="50" value="<?php echo $row_book["ld_item_code"]; ?>" readonly="readonly"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Item Name</td>
                  <td align="center">:</td>
                  <td align="left"><input name="name" type="text" class="body_text" id="name" size="50" value="<?php echo $row_book["ld_item_name"]; ?>" readonly="readonly"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Before Qty</td>
                  <td align="center">:</td>
                  <td align="left"><input name="b_qty" type="text" class="body_text" id="b_qty" size="50" value="<?php echo $row_book["ld_item_qty"]; ?>" readonly="readonly"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Selling Qty</td>
                  <td align="center">:</td>
                  <td align="left"><input name="qty" type="text" class="body_text" id="qty" size="50" value="<?php echo $row_book["sell_qty"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Remain Qty</td>
                  <td align="center">:</td>
                  <td align="left"><input name="remain" type="text" class="body_text" id="amount" size="50" value="<?php echo $row_book["ld_item_remain_qty"]; ?>" readonly="readonly"/></td>
                </tr>
