...
function search_act(page){
	$('#rec_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#rec_div').load("search_activity.php",{'name':$('#name').val(),'id':$('#id').val(),'page':page});
}

function delete_activity(donation_id){
	if(confirm("Do you want to delete this record ?")){
		window.location='delete_activity.php?donation_id='+donation_id;
	}
}
...
function daily_amount(){
		...
		var date = $('#dte').val();
		$('#rec_div').load("daily_amount_activity.php",{'date':$('#date').val()});
          ...
          <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SERACH ACTIVITY</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="right"><p> ID</p></td>
                ...
                <tr class="body_text">
                  <td width="100" height="25" align="right">Name</td>
                  <td align="center">:</td>
                ...
                <tr class="body_text">
                  <td width="100" height="25" align="right">Today</td>
                  <td align="center">:</td>
                  <td width="150" align="left"><input name="date" type="text" class="body_text" id="date" size="30" onchange="daily_amount();"/></td>
                  <td width="100" align="left">&nbsp;</td>
                  <td align="center">&nbsp;</td>
                  <td align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_act('0');"/></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <div id="helpdiv" class="red_text" align="center">
            <?php if(isset($_SESSION['act_del_mes'])){echo $_SESSION['act_del_mes'];}?>
            <?php if(isset($_SESSION['act_up_mes'])){echo $_SESSION['act_up_mes'];}?>
          </div>
        <br />
...
require_once '../library/close.php';
unset($_SESSION['act_del_mes']);
unset($_SESSION['act_up_mes']);
?>