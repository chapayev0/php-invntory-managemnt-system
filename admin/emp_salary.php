...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><form action="add_salary.php" method="post" name="rec_form" id="book_form" enctype="multipart/form-data" onsubmit="return rec_validation();">
          <table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="rounded-corners"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr class="body_text">
                  <td width="200" height="25" align="right"><strong> 	Employee Name </strong></td>
                ...
                <tr class="body_text">
                  <td width="200" height="25" align="right"><strong>
        Description</strong></td>
                  <td align="center">:</td>
                  <td align="left"><textarea name="desc" cols="29" rows="4" class="body_text" id="desc"></textarea></td>
                </tr>
                <tr class="body_text">
                  <td width="200" height="25" align="right"><strong> Amount</strong></td>
                  <td align="center">:</td>
                  <td align="left"><input name="amount" type="text" class="body_text" id="amount" size="32" /></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="right" valign="middle"><strong>Date </strong></td>
                  <td align="center" valign="middle">:</td>
                  <td align="left"><input name="date" type="text" class="body_text" id="date" size="32" /></td>
                </tr>
                <tr class="body_text">
