...
function search_employee(page){
	$('#emp_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#emp_div').load("search_employee.php",{'name':$('#name').val(),'id_no':$('#id_no').val(),'name':$('#name').val(),'nic':$('#nic').val(),'page':page});
}

function delete_emp(emp_id){
	if(confirm("Do you want to delete this Employee ?")){
		window.location='delete_emp.php?emp_id='+emp_id;
	}
}
</script>
<!-- InstanceEndEditable -->
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" -->
            ...
            <tr class="body_text">
              <td><fieldset style="border-color:#666">
                <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr class="body_text">
                    <td height="25" colspan="6" align="center" class="page_title_text">Search Employee</td>
                  </tr>
                  <tr class="body_text">
                    <td width="155" height="25" align="right">Name </td>
                    <td width="15" align="center">:</td>
                    <td width="201" align="left"><input name="name" type="text" class="body_text" id="name" size="20" /></td>
                    <td width="165" align="right">ID No </td>
                    <td width="19" align="center">:</td>
                    <td width="195" align="left"><input name="id_no" type="text" class="body_text" id="id_no" size="20" /></td>
                  </tr>
                  <tr class="body_text">
                    <td height="25" align="right">NIC </td>
                    <td align="center">:</td>
                    <td align="left"><input name="nic" type="text" class="body_text" id="nic" size="20" /></td>
                    <td align="right">&nbsp;</td>
                    <td align="center">&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  ...
                  <tr class="body_text">
                    ...
                    <td align="left">&nbsp;</td>
                    <td align="center">&nbsp;</td>
                    <td align="left"><img src="../images/search.gif" alt="" width="65" height="35" style="cursor:pointer" onclick="search_employee('0');"/></td>
                  </tr>
                </table>
              </fieldset></td>
            </tr>
          ...
          <div id="helpdiv" class="red_text" align="center">
           ...
           <br />
			<div id="emp_div" align="center"></div>
