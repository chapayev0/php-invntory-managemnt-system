...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <form action="update_charity.php" method="post" name="don_form" id="don_form" enctype="multipart/form-data" onsubmit="return don_validation();">
          ...
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="rounded-corners"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="4" align="left" class="page_title_text"><p>EDIT CUSTOMERS DETAILS</p>
                    <p>&nbsp;</p></td>
                </tr>
                <tr class="body_text">
                ...
                <tr class="body_text">
                  ...
                  <td align="center">:</td>
                  <td align="left"><input name="tel" type="text" class="body_text" id="amount3" size="30" value="<?php echo $row_book["section"]; ?>"/></td>
                </tr>
                <tr class="body_text">
