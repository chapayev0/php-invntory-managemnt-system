...
function search_other(page){
	...
	$('#other_div').load("search_trans.php",{'name':$('#name').val(),'acc':$('#acc').val(),'date1':$('#date1').val(),'type':$('#type').val(),'page':page});
}
...
function daily_amount(){
		...
		var date = $('#dte').val();
		$('#other_div').load("daily_amount_salary.php",{'date':$('#date').val()});
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SERACH TRANS. DETAILS</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="left"><p>&nbsp;</p></td>
                ...
                <tr class="body_text">
                  ...
                  <td align="center">:</td>
                  <td width="150" align="left"><select name="name" class="body_text" id="name">
                    <option value="">Select Bank Name</option>
                    <?php bank("");?>
                  </select></td>
                  <td width="200" align="center">Acc Name</td>
                  <td align="center">:</td>
                  <td width="100" align="left"><select name="acc" class="body_text" id="acc">
                ...
                <tr class="body_text">
                  ...
                  <td align="center">&nbsp;</td>
                  <td align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_other('0');"/></td>
                  <td align="left">&nbsp;</td>
                  <td align="center">&nbsp;</td>
                  <td align="left">&nbsp;</td>
                </tr>
