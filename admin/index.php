...
function check_username(u_id){
	$('#uname_div').load("check_username.php",{'u_id':u_id,'uname':$('#uname').val()});
}
</script>
<!-- InstanceEndEditable -->
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <div id="helpdiv" class="red_text" align="center"><?php if(isset($_SESSION['user_up_mes'])){echo $_SESSION['user_up_mes'];}?></div>
        <form action="update_user.php" method="post" name="user_form" id="user_form" onsubmit="return user_validation();">
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td height="25" colspan="3" align="center" class="page_title_text"><p>USER PROFILE</p>
                <p>&nbsp;</p></td>
              </tr>
            <tr class="body_text">
              <td width="125" height="25" align="left">Name</td>
              <td width="20" align="center">:</td>
              <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="25" value="<?php echo $row_user["u_name"]; ?>"/></td>
            </tr>
            <tr class="body_text">
            ...
            <tr class="body_text">
              ...
              <td align="center">:</td>
              <td align="left"><input name="pwd" type="password" class="body_text" id="pwd" size="25" /><input name="old_pwd" id="old_pwd" type="hidden" value="<?php echo $row_user["u_pwd"]; ?>" /></td>
            </tr>
            <tr class="body_text">
