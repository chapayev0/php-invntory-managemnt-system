...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><form id="order_form" name="order_form" method="post" action="add_load.php" onsubmit="return  goods_order_validation();">
                    <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr class="body_text">
                        <td height="25" colspan="3" align="center">&nbsp;</td>
                      </tr>
                      <tr class="body_text">
                        <td width="125" height="25" align="left">Load  No</td>
                        <td width="20" align="center">:</td>
                        <td width="255" align="left"><?php echo getldNo(); ?>
                          <input name="ld_id" id="ld_id" type="hidden" value="<?php echo getldNo(); ?>" /></td>
                      </tr>
                      <tr class="body_text">
                        <td height="25" align="left">Rute</td>
                        <td align="center">:</td>
                      ...
                      <tr class="body_text">
                        <td height="25" align="left">Driver</td>
                        <td align="center">:</td>
                        <td align="left"><select name="dri" class="body_text" id="dri" onchange="get_cus();">
                    ...
                    <table width="835" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="272" align="center" class="tbl_header_right">Name</td>
                        <td width="144" align="center" class="tbl_header_right">Cost Price</td>
                        <td width="147" align="center" class="tbl_header_right">QTY</td>
                        <td width="151" align="center" class="tbl_header_right">Amount</td>
                        
                      </tr>
                      <tr>
                        <td height="25" colspan="7" align="left"><table width="774" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="273" align="left" class="border_bottom_left"><input type="hidden" name="goods_id_1" id="goods_id_1" />                              <input name="goods_1" type="text" class="body_text" id="goods_1" onfocus="load_ingre_goods('goods_1','goods_id_1','price_1');" size="40"/></td>
                            <td width="144" align="right" class="border_bottom_left"><input name="price_1" type="text" class="body_text" id="price_1" size="10" onfocus="load_ingre_goods('goods_1','goods_id_1','price_1');"/></td>
                            <td width="147" align="right" class="border_bottom_left"><input name="qty_1" type="text" class="body_text" id="qty_1" size="10" onkeyup="calc_total('price_1','qty_1','amount_1');"/></td>
                            <td width="151" align="right" class="border_bottom_left_right"><input name="amount_1" type="text" class="body_text" id="amount_1" size="15" readonly="readonly" style="text-align:right"/></td>
                      ...
                      <tr>
                        ...
                        <td align="right"><input name="total" type="text" class="body_text" id="total" size="15" style="text-align:right"/></td>
                      ...
                      <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td align="right"><input  type="button" name="add" id="add" value="Add" onclick="form_submission('add','order_form');"/></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
