...
$(document).ready(function(){
	$('#l_date').datepicker({dateFormat: 'yy-mm-dd'});
		$('#p_id_1').focus();
});
...
/*function service(item_name,item_id,price,p_id,div_id,qty,p_no,qty_id){
	$("#"+item_name).autocomplete("js_service.php", {
		width: 275,
		matchContains: true,
		selectFirst: true
	});
	$("#"+item_name).result(function(event, data, formatted) {
		...
		$("#"+p_id).val(data[3]);
		$("#"+p_no).val(data[3]);
		check_stock(div_id,data[1],qty,data[0],qty_id);
		cal_total();
		$('#'+qty_id).focus();
	});	
}*/
...
function get_details(){
	$.ajax({
  type: 'POST',
  url: "get_date.php?bill_no="+$("#bill_no").val(), 
       // call php function , phpFunction=function Name , x= parameter 
  data: {},
  success: function(data1){
	    //alert('g');
		...
		var pay = arr[3];
			...
			document.getElementById("nic_label").style.display="block";
			document.getElementById("address_label").style.display="block";
			document.getElementById("pay_label").style.display="block";
			//document.getElementById("payment_label").style.display="block";
...
var firstDate = new Date($('#l_date').val());
var secondDate = new Date($('#t_date').val());
...
var monthDiff=(secondDate.getMonth() + y2*12)-(firstDate.getMonth() +y1*12);
...
//alert(y1);
	...
	var month=$('#pay').val();
	net_amount =((parseFloat(month))+month*(monthDiff)*5/100)

	
	//$('#payment').val(net_amount);
	$('#payment').val(roundNumber(net_amount,2));
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <form action="add_step_bill.php" method="post" name="quotation_form" lang="quotation_form" onsubmit="return bill_validation();">
              ...
              <td class="rounded-corners"><table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <table width="475" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr class="body_text">
                    <td height="25" colspan="3" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr class="body_text">
                        ...
                        <td align="left"><select name="bill_no" class="body_text" id="bill_no" onchange="get_details();">
                  ...
                  <tr class="body_text">
                    ...
                    <td width="20" align="center">:</td>
                    <td align="left"><input name="nic" type="text" class="body_text" id="nic" style="text-align:left" size="24" /></td>
                  </tr>
                  <tr class="body_text">
                    <td width="175" height="25" align="left">Address</td>
                    <td align="center">:</td>
                    <td width="280" align="left"><input name="address" type="text" class="body_text" id="address" style="text-align:left" size="24" /></td>
                  </tr>
                  <tr class="body_text">
                    <td height="25" align="left">Customer</td>
                    <td align="center">:</td>
                    <td align="left"><input name="name" type="text" class="body_text" id="name" style="text-align:left" size="24" /></td>
                  </tr>
                  <tr class="body_text">
                    <td height="25" align="left">Month Payment</td>
                    <td align="center">:</td>
                    <td align="left"><input name="pay" type="text" class="body_text" id="pay" style="text-align:left" size="24" /></td>
                  </tr>
                  <tr class="body_text">
                    <td height="25" align="left">Last Date</td>
                    <td align="center">:</td>
                    <td align="left"><input name="l_date" type="text" class="body_text" id="l_date" style="text-align:left" size="24"  onmouseup="cal_total();"/></td>
                  </tr>
                  <tr class="body_text">
                  ...
                  <tr class="body_text">
                    <td height="25" align="left">Payment</td>
                    <td align="center">:</td>
                    <td align="left"><input name="payment" type="text" class="body_text" id="payment" style="text-align:left" size="24"  onmouseup="cal_total();"/></td>
                  </tr>
                  <tr class="body_text">
                    <td colspan="3" align="center"><div id="token" ><img src="../images/add.gif" width="65" id="create" height="35" style="cursor:pointer" onclick="form_submission('create','quotation_form');"/> </div></td>
                  </tr>
                </table>
                <p>&nbsp;</p>
