...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr class="body_text">
                        <td height="25" colspan="3" align="center">View GRNs</td>
                      </tr>
                      <tr class="body_text">
                        <td width="125" height="25" align="left">GRN  No</td>
                        <td width="20" align="center">:</td>
                        <td width="255" align="left"><?php echo $row_order["grn_id"]; ?></td>
                      </tr>
                      <tr class="body_text">
                        <td height="25" align="left">Date</td>
                        <td align="center">:</td>
                        <td align="left"><?php echo $row_order["grn_date"]; ?></td>
                      </tr>
                    </table>
                    ...
                    <?php 
        $query_stock="SELECT * FROM tbl_stock WHERE grn_id='$grn_id'";
        ...
        ?>
                    <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td align="center" >&nbsp;</td>
                        <td align="center" >&nbsp;</td>
                        <td align="center" ><form action="print_grn.php" method="post" name="stock_form" target="_blank" id="stock_form">
       <input name="grn_id" id="grn_id" type="hidden" value="<?php  echo $_REQUEST['grn_id']; ?>" />
        ...
        <input type="submit" name="print" id="print" value="print" />
                      ...
                      <tr>
                        ...
                        <td width="291" align="center" class="tbl_header_right">Item code</td>
                        <td width="119" align="center" class="tbl_header_right">Cost Price</td>
                        <td width="104" align="center" class="tbl_header_right">QTY</td>
                        <td width="125" align="center" class="tbl_header">Amount</td>
            ...
            while($row_stock=mysql_fetch_assoc($result_stock)){
                ...
                ?>
                      <tr class="body_text">
                        ...
                        <td width="291" align="center" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_stock["p_name"]; ?></td>
                        <td width="119" align="center" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_stock["st_price"]; ?></td>
                        <td width="104" align="center" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_stock["st_qty"]; ?></td>
                        <td align="right" class="border_bottom_left_right" style="padding-left:3pt;"><?php echo number_format((round(($row_stock["st_price"]*$row_stock["st_qty"]),2)),2,'.',','); ?></td>
                      ...
                      <tr>
                        ...
                        <td align="right">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        <td align="right" class="body_text">Total</td>
                        <td align="right" class="body_text"><span class="body_text" style="padding-right:3pt;"><?php echo number_format($total_amount,2,'.',','); ?></span></td>
