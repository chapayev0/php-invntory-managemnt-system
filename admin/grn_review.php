...
function search_other(page){
	...
	$('#other_div').load("search_rev_grn.php",{'name':$('#name').val(),'code':$('#code').val(),'page':page});
}
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --> <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SEARCH STOCK BALANCE</td>
                </tr>
                <tr class="body_text">
                  <td width="108" height="25" align="left">Product Code</td>
                  <td width="6" align="center">:</td>
                  <td width="240" align="left"><input name="code" type="text" class="body_text" id="code" size="30" /></td>
                  <td width="183" align="center">&nbsp;</td>
                  <td width="18" align="center">&nbsp;</td>
                  <td width="95" align="left">&nbsp;</td>
                </tr>
                <tr class="body_text">
                  <td width="108" height="25" align="left">Product Name</td>
                  <td align="center">:</td>
                  <td width="240" align="left"><input name="name" type="text" class="body_text" id="name" size="30" /></td>
                  <td width="183" align="center">&nbsp;</td>
                  <td align="center">&nbsp;</td>
                  <td width="95" align="left">&nbsp;</td>
                </tr>
                <tr class="body_text">
                  ...
                  <td align="center">&nbsp;</td>
                  <td width="240" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_other('0');"/></td>
