...
function search_loans(page){
	$('#loan_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#loan_div').load("search_loans.php",{'name':$('#name').val(),'id':$('#id').val(),'date1':$('#date1').val(),'date2':$('#date2').val(),'page':page});
}

function delete_rec(b_id){
	if(confirm("Do you want to delete this record ?")){
		window.location='delete_loan.php?b_id='+b_id;
	}
}
...
function daily_amount(){
		...
		var date = $('#dte').val();
		$('#loan_div').load("daily_amount_loans.php",{'dat':$('#dat').val()});
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SERACH BANKING</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="left"><p>Acc Name</p></td>
                ...
                <tr class="body_text">
                  <td width="100" height="25" align="left">Bank Name</td>
                  <td align="center">:</td>
                  <td width="150" align="left"><input name="name" type="text" class="body_text" id="name" size="30" /></td>
                  <td width="200" align="center">Today&nbsp;&nbsp; :
                    <input name="dat" type="text" class="body_text" id="dat" size="20" onchange="daily_amount();"/></td>
                  <td align="center">&nbsp;</td>
                ...
                <tr class="body_text">
                  ...
                  <td align="center">&nbsp;</td>
                  <td width="100" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_loans('0');"/></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <div id="helpdiv" class="red_text" align="center">
            <?php if(isset($_SESSION['rec_del_mes'])){echo $_SESSION['rec_del_mes'];}?>
            <?php if(isset($_SESSION['rec_up_mes'])){echo $_SESSION['rec_up_mes'];}?>
          </div>
          <br />
        <div id="loan_div" align="center"></div>
