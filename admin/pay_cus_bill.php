...
function menu(menu_name,price,name,war){
...
function get_cus(){
	$.ajax({
  type: 'POST',
  url: "get_customer.php?cus="+$("#cus").val(), 
  ...
  success: function(data1){
		...
		var address = arr[1];
			...
			document.getElementById("nic_label").style.display="block";
	...
	for(i=1;i<=count_item;i++){
		...
		/*if(document.getElementById(free).checked == true){
			...
			if(document.getElementById(price) && $('#'+price).val() != ""){
				...
				d=isNaN(d) ? 1 : (100-Number(d))/100;
				$('#'+amount).val(roundNumber((parseFloat($('#'+price).val())*parseFloat(qty)*d),2));
				total_amount += parseFloat($('#'+price).val())*parseFloat(qty)*d;
...
<style type="text/css">
#sys tr td table tr #cbody form table tr .rounded-corners table {
	font-weight: bold;
}
#sys tr td table tr #cbody form table tr td table .body_text td {
	font-weight: bold;
}
</style>
<!-- InstanceEndEditable -->
            ...
            <tr>
              <td class="rounded-corners">
                <table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="35" align="left" class="page_title_text" style="padding-left:15pt;">ADD BILL</td>
                    </tr>
                  </table>
                  <table width="475" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr class="body_text">
                      <td height="25" align="left">PO</td>
                      <td align="center">:</td>
                      <td align="left"><input name="po" type="text" id="po" size="15" /></td>
                    </tr>
                    <tr class="body_text">
                      ...
                      <td width="280" align="left">
                        <?php echo getBillNo(); ?>
                        <input name="bill_no" id="bill_no" type="hidden" value="<?php echo getBillNo(); ?>" />
                        </td>
                    </tr>
                    <!--<tr class="body_text">
                    ...
                    <tr class="body_text">
                      <td height="25" colspan="3" align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr class="body_text">
                            <td width="175" height="25" align="left">Customer Name</td>
                            <td width="20" align="center">:</td>
                            <td align="left"><select name="name" class="body_text" id="name" onchange="get_cus();">
                        ...
                        <tr class="body_text">
                          <td height="25" align="left">Invoice No</td>
                          <td align="center">:</td>
                          <td align="left"><label for="inv_no"></label>
                          <input name="inv_no" type="text" id="inv_no" size="15" /></td>
                        </tr>
                        <tr class="body_text">
                        ...
                        <tr class="body_text">
                          <td height="25" align="left">Today</td>
                          <td align="center">:</td>
                          <td align="left"><input name="t_date" type="text" class="body_text" id="t_date" style="text-align:left" size="24" value='<?php echo date('Y-m-d'); ?>'/></td>
                        </tr>
                        <tr class="body_text">
          ...
          <div id="cus_div" align="center"></div>
                  ...
                  <table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td width="246" align="center" class="tbl_header_right"> Code</td>
                      <td width="246" align="center" class="tbl_header_right">Name</td>
                      <td width="111" align="center" class="tbl_header_right">QTY</td>
                      <td width="104" align="center" class="tbl_header_right">Unit Price</td>
                      <td width="101" align="center" class="tbl_header_right">Warranty</td>
                      <td width="72" align="center" class="tbl_header_right">Dist(%)</td>
                      <td width="83" align="center" class="tbl_header_right">Amount</td>
                    </tr>
                    <tr>
                      ...
                      <table width="915" border="0" cellspacing="0" cellpadding="0">
                        <tr class="body_text">
                          <td width="31" height="25" align="center"><img src="../images/add.png" width="16" height="16" style="cursor:pointer" onclick="gen_item('item_div_2','2');$('#count_item').val(2);"/></td>
                          <td width="225" align="left" class="border_bottom_left"><input name="item_1" type="text" class="body_text" id="item_1" size="30" onfocus="menu('item_1','price_1','name_1','war_1','qty_div_1',$('#qty_1').val
                          (),'p_no_1','qty_1');"/>                            <input name="item_id_1" type="hidden" value="" id="item_id_1"/></td>
                          <td width="199" align="right" class="border_bottom_left"><input name="name_1" type="text" class="body_text" id="name_1" size="30" onkeyup="cal_total();" style="text-align:right" onkeydown="gen_new_item(event,'item_div_2','2');"/></td>
                          <td width="116" align="right" class="border_bottom_left"><input name="qty_1" type="text" class="body_text" id="qty_1" size="10" onkeyup="cal_total();" style="text-align:right" onkeydown="gen_new_item(event,'item_div_2','2');"/></td>
                          <td width="98" align="right" class="border_bottom_left"><input name="price_1" type="text"   class="body_text" id="price_1" style="text-align:right" size="10" />                          </td>
                          <td width="71" align="right" class="border_bottom_left"><input name="war_1" type="text"   class="body_text" id="war_1" style="text-align:right" size="10" /></td>
                          <td width="71" align="right" class="border_bottom_left"><input name="discount_1" type="text" class="body_text" id="discount_1" style="text-align:right" size="4" onkeyup="cal_total();" onkeydown="gen_new_item(event,'item_div_2','2');" /></td>
                          
                          <td width="84" align="right" class="border_bottom_left_right">
                            <input name="amount_1" type="text" class="body_text" id="amount_1" style="text-align:right" size="10" readonly="readonly"/>
                          </td>
                          <td width="20" align="center">&nbsp;</td>
                        </tr>
                      </table>
                      ...
                      <tr>
                        <td height="25" colspan="10" align="right"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr class="body_text">
                            <td width="27" height="25">&nbsp;</td>
                            <td width="426" align="right">&nbsp;</td>
                            <td width="215" align="right" ><strong>Gross Amount</strong></td>
                            <td width="105" align="right"><input name="total" type="text" class="body_text" id="total" style="text-align:right" size="10" readonly="readonly"/></td>
                            <td width="37">&nbsp;</td>
                          </tr>
                          <tr class="body_text">
                            <td height="25">&nbsp;</td>
                            <td align="right">&nbsp;</td>
                            <td align="right">Add Discount %</td>
                            <td align="right"><input name="dis" type="text" class="body_text" id="dis" style="text-align:right" size="10" onkeyup="cal_total();" /></td>
                            <td>&nbsp;</td>
                          </tr>
                          <tr class="body_text">
                            <td height="25">&nbsp;</td>
                            ...
                            <td align="right"><input name="tot" type="text" class="body_text" id="tot" style="text-align:right" size="10" onkeyup="cal_total();" /></td>
                            <td>&nbsp;</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        ...
                        <td height="25" align="right">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        <td height="25" align="right"><img src="../images/add.gif" width="65" id="create" height="35" style="cursor:pointer" onclick="form_submission('create','quotation_form');"/></td>
                        <td align="right">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        <td height="25" align="right">&nbsp;</td>
                      </tr>
