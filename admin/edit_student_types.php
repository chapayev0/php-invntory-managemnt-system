...
function student_type_validation(){
	with(document.student_type_form){
		valid=true;
		if(stu_type.value == ""){
			valid=false;
			alert("Enter Student Type");
			stu_type.focus();
		}else if(bk_no.value == ""){
			valid=false;
			alert("Enter # Of Books");
			bk_no.focus();
		}
		return valid;
	}
         ...
         <table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
            	<td align="center" class="rounded-corners">
                    <form action="update_student_type.php" method="post" name="student_type_form" id="student_type_form" onsubmit="return student_type_validation();">
                    <input name="stu_tp_id" id="stu_tp_id" type="hidden" value="<?php echo $stu_tp_id; ?>" />
                      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr class="body_text">
                          <td height="25" colspan="3" align="left" class="page_title_text">EDIT STUDENT TYPE</td>
                          </tr>
                        <tr class="body_text">
                          <td width="125" height="25" align="left">Student Type</td>
                          <td width="20" align="center">:</td>
                          <td width="255" align="left"><input name="stu_type" type="text" class="body_text" id="stu_type" size="35" value="<?php echo $row_stu_tp["stu_tp_name"]; ?>"/></td>
                        </tr>
                        <tr class="body_text">
                          <td height="25" align="left"># Of Books</td>
                          <td align="center">:</td>
                          <td align="left">
                            <input name="bk_no" type="text" class="body_text" id="bk_no" size="10" style="text-align:right" value="<?php echo $row_stu_tp["stu_tp_book_no"]; ?>"/>
                          </td>
                        </tr>
                        <tr class="body_text">
