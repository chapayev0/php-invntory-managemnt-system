...
function search_other(page){
	$('#other_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#other_div').load("search_day_items.php",{'code':$('#code').val(),'date':$('#date').val(),'date2':$('#date2').val(),'page':page});
}
...
function daily_amount(){
		...
		var date = $('#dte').val();
		$('#other_div').load("daily_amount_other.php",{'dat':$('#dat').val()});
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SEARCH DAY ITEMS</td>
                </tr>
                <tr class="body_text">
                  <td width="128" height="25" align="left">&nbsp;</td>
                  <td width="15" align="center">&nbsp;</td>
                  <td width="93" align="left">&nbsp;</td>
                  <td width="157" align="center">&nbsp;</td>
                  <td width="16" align="center">&nbsp;</td>
                  <td width="241" align="left">&nbsp;</td>
                </tr>
                <tr class="body_text">
                  <td width="128" height="25" align="left">Product code</td>
                  <td align="center">:</td>
                  <td width="93" align="left"><input name="code" type="text" class="body_text" id="code" size="10" /></td>
                  <td width="157" align="center">Date1</td>
                  <td align="center">:</td>
                  <td width="241" align="left"><input name="date" type="text" class="body_text" id="date" size="30" /></td>
                </tr>
                <tr class="body_text">
                  <td width="128" height="25" align="left">&nbsp;</td>
                  <td align="center">&nbsp;</td>
                  <td width="93" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_other('0');"/></td>
                  <td width="157" align="center">Date2</td>
                  <td align="center">:</td>
                  <td width="241" align="left"><input name="date2" type="text" class="body_text" id="date2" size="30" /></td>
                </tr>
              </table></td>
            </tr>
          </table>
        ...
        <br />
        <div id="other_div" align="center"></div><!-- InstanceEndEditable --></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
