...
$user_type=$_SESSION['user_type'];
	...
	$b_id=$_GET['b_id'];
	$query_book="SELECT * FROM  tbl_loans WHERE b_id='$b_id' AND b_status='0'";
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <form action="update_loans.php" method="post" name="don_form" id="don_form" enctype="multipart/form-data" onsubmit="return don_validation();">
          ...
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="rounded-corners"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="4" align="left" class="page_title_text"><p>EDIT LOANS DETAILS</p>
                    <p>&nbsp;</p></td>
                </tr>
                <tr class="body_text">
                  <td width="125" height="25" align="left">Name</td>
                  <td width="20" align="center">:</td>
                  <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="20" value="<?php echo $row_book["b_nam"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Acc No</td>
                  <td align="center">:</td>
                  <td align="left"><input name="nm" type="text" class="body_text" id="nm" size="20" value="<?php echo $row_book["acc_name"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">address</td>
                  <td align="center">:</td>
                  <td align="left"><input name="amount" type="text" class="body_text" id="amount" size="20" value="<?php echo $row_book["address"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Manager</td>
                  <td align="center">:</td>
                  <td align="left"><input name="man" type="text" class="body_text" id="man" size="20" value="<?php echo $row_book["manager"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Email</td>
                  <td align="center">:</td>
                  <td align="left"><input name="mail" type="text" class="body_text" id="mail" size="20" value="<?php echo $row_book["manager"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Fax</td>
                  <td align="center">:</td>
                  <td align="left"><input name="fax" type="text" class="body_text" id="fax" size="20" value="<?php echo $row_book["manager"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Tel</td>
                  <td align="center">:</td>
                  <td align="left"><input name="tel" type="text" class="body_text" id="tel" size="20" value="<?php echo $row_book["manager"]; ?>"/></td>
                </tr>
                <tr class="body_text">
