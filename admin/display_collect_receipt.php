...
function search_bill(page){
	...
	$('#bill_div').load("search_collect_recipt.php",{'name':$('#name').val(),'no':$('#no').val(),'bill_type':$('#bill_type').val(),'date':$('#date').val(),'page':page});
}
...
function daily_amount(){
		var date = $('#dte').val();
		$('#bill_div').load("daily_amount.php",{'date':$('#date').val()});		
}
</script>
<!-- InstanceEndEditable -->
            ...
            <tr class="body_text">
              <td><fieldset style="border-color:#666">
                <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr class="body_text">
                    <td height="25" colspan="6" align="left" class="page_title_text">SEARCH PAID RECEIPTS TO CHANTERS/සෙවීම </td>
                  </tr>
                  <tr class="body_text">
                    <td width="125" height="25" align="left">Name</td>
                    <td width="20" align="center">:</td>
                    <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="25" /></td>
