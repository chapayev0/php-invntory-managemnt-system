...
function search_goods_received(page){
	$('#received_div').load("search_grn.php",{'grn_no':$('#grn_no').val(),'f_date':$('#f_date').val(),'t_date':$('#t_date').val(),'page':page});
}
...
function delete_goods_order(grn_id){
	if(confirm("Do you want to delete this record?")){
		window.location='delete_goods_order.php?grn_id='+grn_id;
	}
}
</script>
<!-- InstanceEndEditable -->
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr class="body_text">
                        <td width="125" height="25" align="right">GRN No</td>
                        <td width="20" align="center">:</td>
                        <td width="255" align="left"><input name="grn_no" type="text" class="body_text" id="grn_no" size="20" /></td>
