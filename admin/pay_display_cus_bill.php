...
function search_other(page){
	...
	$('#other_div').load("search_step_bill.php",{'name':$('#name').val(),'id':$('#id').val(),'page':page});
}

function delete_rec(c_id){
	if(confirm("Do you want to delete this record ?")){
		window.location='delete_charity.php?c_id='+c_id;
	}
}
...
function daily_amount(){
		...
		var date = $('#dte').val();
		$('#other_div').load("daily_amount_charity.php",{'dat':$('#dat').val()});
...
<style type="text/css">
#sys tr td table tr #cbody table .body_text .rounded-corners table {
	font-weight: bold;
}
</style>
<!-- InstanceEndEditable -->
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">&nbsp;</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="right"> <p>Name</p></td>
                  <td width="20" align="center">:</td>
                  <td width="150" align="left"><input name="name" type="text" class="body_text" id="name" size="15" /></td>
                  <td width="200" align="right">&nbsp;</td>
                  <td width="20" align="center">&nbsp;</td>
                  <td width="100" align="left">&nbsp;</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="right">Bill No</td>
                  <td align="center">:</td>
                  <td width="150" align="left"><input name="id" type="text" class="body_text" id="id" size="15" onchange="daily_amount();" /></td>
                  <td width="200" align="center"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_other('0');"/></td>
                  <td align="center">&nbsp;</td>
                  <td width="100" align="left">&nbsp;</td>
                </tr>
                <tr class="body_text">
