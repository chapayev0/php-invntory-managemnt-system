...
$user_type=$_SESSION['user_type'];
	...
	$emp_id=$_GET['emp_id'];
	$query_book="SELECT * FROM tbl_emp WHERE emp_id='$emp_id' AND emp_status='0'";
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <form action="update_employee.php" method="post" name="don_form" id="don_form" enctype="multipart/form-data" onsubmit="return don_validation();">
        <input name="emp_id" id="emp_id" type="hidden" value="<?php echo $emp_id; ?>" />
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="rounded-corners"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="4" align="left" class="page_title_text"><p>EDIT EMPLOYEE DETAILS</p>
                    <p>&nbsp;</p></td>
                </tr>
                <tr class="body_text">
                  <td width="125" height="25" align="left">Employee Name</td>
                  <td width="20" align="center">:</td>
                  <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="25" value="<?php echo $row_book["emp_name"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Type</td>
                  <td align="center">:</td>
                  <td align="left"><input name="type" type="text" class="body_text" id="type" size="25" value="<?php echo $row_book["type"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">ID No</td>
                  <td align="center">:</td>
                  <td align="left"><input name="id_no" type="text" class="body_text" id="id_no" size="25" value="<?php echo $row_book["emp_no"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">NIC</td>
                  <td align="center">:</td>
                  <td align="left"><input name="nic_no" type="text" class="body_text" id="nic_no" size="25" value="<?php echo $row_book["emp_nic"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Tel No</td>
                  <td align="center">:</td>
                  <td align="left"><input name="tel" type="text" class="body_text" id="tel" size="25" value="<?php echo $row_book["emp_tel"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Address</td>
                  <td align="center">:</td>
                  <td align="left"><input name="address" type="text" class="body_text" id="address" size="25" value="<?php echo $row_book["emp_address"]; ?>"/></td>
                </tr>
                <tr class="body_text">
