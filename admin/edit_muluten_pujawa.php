...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        ...
        <form action="update_muluten_pujawa.php" method="post" name="don_form" id="don_form" enctype="multipart/form-data" onsubmit="return don_validation();">
        <input name="id_muluthan_pujawa" id="id_muluthan_pujawa" type="hidden" value="<?php echo $id_muluthan_pujawa; ?>" />
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="rounded-corners"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="3" align="center"><B><H2>මුලුතැන් පුජාව භාර ගත් අයගෙ විස්තර යාවත් කාලීන කිරීම කිරිම</H2></B></td>
                  </tr>
                <tr class="body_text">
                  <td width="220" height="25" align="left">Name / නම</td>
                  <td width="41" align="center">:</td>
                  <td width="250" align="left"><input name="name" type="text" class="body_text" id="name" size="50" value="<?php echo $row_book["name"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Address /  ලිපිනය</td>
                  <td align="center">:</td>
                  <td align="left">
				  <textarea name="address" id="address" cols="15" rows="3"><?php echo $row_book["address"]; ?></textarea>
                	</td>
				</tr>
                <tr class="body_text">
                  <td height="25" align="left">Tel No /  දුරකතන අංකය</td>
                  <td align="center">:</td>
                  <td align="left"><input name="tel" type="text" class="body_text" id="tel" size="20" value="<?php echo $row_book["contact_no"]; ?>"/></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">Date /  දිනය </td>
                  <td align="center">:</td>
                ...
                <tr class="body_text">
				  ...
				  <?php if(isset($_SESSION['error_mes']))echo $_SESSION['error_mes']; ?>
                  </td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="left">&nbsp;</td>
