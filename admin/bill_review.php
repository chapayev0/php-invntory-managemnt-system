...
function search_bills(page){
	...
	$('#bill_div').load("search_r_bill.php",{'bill_no':$('#bill_no').val(),'cus':$('#cus').val(),'f_date':$('#f_date').val(),'t_date':$('#t_date').val(),'page':page});
}
      ...
      <table width="820" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr class="body_text">
          <td align="center" class="rounded-corners"><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td height="25" colspan="7" align="left" class="page_title_text"> BILLS DETAILS</td>
            </tr>
            <tr class="body_text">
              <td width="125" height="25" align="left">Bill No</td>
              <td width="20" align="center">:</td>
              <td colspan="2" align="left"><input name="bill_no" type="text" class="body_text" id="bill_no" size="20" /></td>
            ...
            <tr class="body_text">
              ...
              <td align="center">:</td>
              <td colspan="2" align="left"><select name="cus" class="body_text" id="cus">
                <option value="">Select Cus Name</option>
                <?php cus("");?>
              </select></td>
              <td colspan="3" align="left"><div id="pay_div"></div></td>
            </tr>
