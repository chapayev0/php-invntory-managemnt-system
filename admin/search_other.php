...
$rows_count=0;
$get_number_of_rows=mysqli_query($connection,$sql_count) or die("Unable to select data from the tbl_other in count. " . mysqli_error());
...
$result_book=mysqli_query($connection,$query_book) or die("Unable to select data from the tbl_other. ".mysqli_error());
