...
function search_other(page){
	...
	$('#other_div').load("search_other.php",{'name':$('#name').val(),'id':$('#id').val(),'page':page});
}

function delete_rec(v_id){
	if(confirm("Do you want to delete this record ?")){
		window.location='delete_veh.php?v_id='+v_id;
	}
}
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SERACH VEHICLES</td>
                </tr>
                <tr class="body_text">
                  <td width="100" height="25" align="left"> <p>Veh No </p></td>
                ...
                <tr class="body_text">
                  <td width="100" height="25" align="left">Owner Name</td>
                  <td align="center">:</td>
