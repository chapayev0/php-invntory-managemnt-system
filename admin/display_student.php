...
function search_student(page){
	...
	$('#student_div').load("search_student.php",{'name':$('#name').val(),'id_no':$('#id_no').val(),'nic':$('#nic').val(),'tel':$('#tel').val(),'lib_id':$('#lib_id').val(),'stu_tp_id':$('#stu_tp_id').val(),'page':page});
}

function delete_student(stu_id){
	if(confirm("Do you want to delete this record ?")){
		window.location='delete_student.php?stu_id='+stu_id;
	}
}
</script>
<!-- InstanceEndEditable -->
      ...
      <tr>
        ...
        <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
            	<td>
                	<fieldset style="border-color:#666">
                      <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr class="body_text">
                          <td height="25" colspan="6" align="left" class="page_title_text">SEARCH STUDENTS</td>
                        </tr>
                        <tr class="body_text">
                          <td width="125" height="25" align="left">Name</td>
                          <td width="20" align="center">:</td>
                          <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="35" /></td>
                          <td width="125" align="left">ID No</td>
                          <td width="20" align="center">:</td>
                          <td width="205" align="left"><input name="id_no" type="text" class="body_text" id="id_no" size="25" /></td>
                        </tr>
                        <tr class="body_text">
                          ...
                          <td align="center">:</td>
                          <td align="left"><input name="tel" type="text" class="body_text" id="tel" size="15" /></td>
                        </tr>
                        <tr class="body_text">
                          <td height="25" align="left">Library ID</td>
                          <td align="center">:</td>
                          <td align="left"><input name="lib_id" type="text" class="body_text" id="lib_id" size="25" /></td>
                          <td align="left">Student Type</td>
                          <td align="center">:</td>
                        ...
                        <tr class="body_text">
                          ...
                          <td align="left">&nbsp;</td>
                          <td align="center">&nbsp;</td>
                          <td align="left"><img src="../images/search.gif" width="65" height="35" style="cursor:pointer" onclick="search_student('0');"/></td>
                        </tr>
                      </table>
                     </fieldset>
                </td>
               ...
               <div id="helpdiv" class="red_text" align="center"><?php if(isset($_SESSION['stu_up_mes'])){echo $_SESSION['stu_up_mes'];}?><?php if(isset($_SESSION['stu_del_mes'])){echo $_SESSION['stu_del_mes'];}?></div>
        <br />
...
require_once '../library/close.php';
unset($_SESSION['stu_up_mes']);
unset($_SESSION['stu_del_mes']);
?>