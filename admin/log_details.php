...
function search_act(page){
	...
	$('#rec_div').load("search_login.php",{'name':$('#name').val(),'page':page});
}
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td height="35" align="center" class="page_title_text"><!-- InstanceBeginEditable name="Editable_Title" --><br />
          ...
          <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td width="100" height="25" align="right"><p>&nbsp;</p>
                    <p>Name</p></td>
                  <td width="20" align="center"><p>&nbsp;</p>
                    <p>:</p></td>
                  <td colspan="2" align="left"><p>LOGIN DETAILS</p>
                    <p><select name="name" class="body_text" id="name" >
                ...
                <tr class="body_text">
                  ...
                  <td align="center">&nbsp;</td>
                  <td width="150" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_act('0');"/></td>
