...
function gen_cat(div_id,num){
	$('#'+div_id).load("m_gen_outlet.php",{'num':num});
}
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
        <td>&nbsp;</td>
        <td height="35" align="center" class="page_title_text"><!-- InstanceBeginEditable name="Editable_Title" --><p>&nbsp;</p>
                    <p>&nbsp;</p><!-- InstanceEndEditable --></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --><form action="add_rute.php" method="post" name="cat_form" id="cat_form" onsubmit="return cat_validation();">
                    <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="22" colspan="3" align="center"><div id="helpdiv" class="red_text" align="center"></div></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td height="19" align="center" class="tbl_header">&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="50">&nbsp;</td>
                        <td width="300" height="19" align="center" class="tbl_header">Add Category Name</td>
                        <td width="50">&nbsp;</td>
                      </tr>
                      <tr class="body_text">
                        <td height="25" colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr class="body_text">
                            <td width="50" height="25" align="center"><img src="../images/add.png" alt="" width="16" height="16" style="cursor:pointer" onclick="gen_cat('cat_div_2','2');$('#item_count').val(2);"/></td>
                            <td width="300" align="center" class="border_bottom_left_right"><input name="cat_1" type="text" class="body_text" id="cat_1" size="35" /></td>
                            <td width="50" align="center">&nbsp;</td>
                          </tr>
                        </table>
                          <input name="item_count" id="item_count" type="hidden" value="1" />
                          <div id="cat_div_2"></div></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td height="35" align="right"><img src="../images/add.gif" alt="" width="65" height="35" id="add" style="cursor:pointer" onclick="form_submission('add','cat_form');"/></td>
                        <td>&nbsp;</td>
                      </tr>
                    </table>
