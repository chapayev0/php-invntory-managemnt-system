...
function search_fine(page){
	$('#fine_div').load("search_fine.php",{'f_date':$('#f_date').val(),'t_date':$('#t_date').val(),'book_code':$('#book_code').val(),'stu_lib_id':$('#stu_lib_id').val(),'page':page});
}
</script>
<!-- InstanceEndEditable -->
      ...
      <tr>
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" -->
          ...
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td height="25" colspan="3" align="left" class="page_title_text">FINE COLLECTION REPORT</td>
              </tr>
            <tr class="body_text">
              <td height="25" width="125" align="left">Date</td>
              <td width="20" height="25" align="center">&nbsp;</td>
              <td width="255" height="25" align="left">From
...
<input name="t_date" type="text" class="body_text" id="t_date" size="10"/></td>
            ...
            <tr class="body_text">
              <td height="25" align="left">Book ID</td>
              <td height="25" align="center">:</td>
              <td height="25" align="left"><input name="book_code" type="text" class="body_text" id="book_code" size="20" /></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">Student Library ID</td>
              <td height="25" align="center">:</td>
              <td height="25" align="left"><input name="stu_lib_id" type="text" class="body_text" id="stu_lib_id" size="20" /></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">&nbsp;</td>
              <td height="25" align="center">&nbsp;</td>
              <td height="25" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_fine('0');"/></td>
            </tr>
          </table>
          </td>
          </tr>
          ...
          <br />
		<div id="fine_div" align="center"></div>
