...
function search_other(page){
	...
	$('#other_div').load("search_salary.php",{'name':$('#name').val(),'id':$('#id').val(),'date1':$('#date1').val(),'date2':$('#date2').val(),'page':page});
}
...
<li><a href="../logout.php">LOGOUT</a></li>
      ...
      <tr>
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SERACH SALARY DETAILS</td>
                </tr>
                <tr class="body_text">
                ...
                <tr class="body_text">
                  <td width="100" height="25" align="left">Employee Name</td>
                  <td align="center">:</td>
                ...
                <tr class="body_text">
                  ...
                  <td align="center">&nbsp;</td>
                  <td align="left"><input name="date" type="text" class="body_text" id="date" size="30" onchange="daily_amount();"/></td>
                  <td align="left">&nbsp;</td>
                  <td align="center">&nbsp;</td>
                  <td align="left">&nbsp;</td>
                </tr>
                <tr class="body_text">
                  ...
                  <td align="center">&nbsp;</td>
                  <td width="150" align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_other('0');"/></td>
        ...
        <br />
        <div id="other_div" align="center"></div>
