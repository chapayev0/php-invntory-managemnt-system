...
function search_other(page){
	...
	$('#other_div').load("search_rev_load.php",{'name':$('#name').val(),'page':page});
}
        ...
        <td align="left" id="cbody"><!-- InstanceBeginEditable name="Editable_Body" --> <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td align="center" class="rounded-corners"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="24" colspan="6" align="center" class="page_title_text">SEARCH LOAD BALANCE</td>
                </tr>
                
                <tr class="body_text">
                  <td width="100" height="25" align="left">Product Name</td>
                  <td align="center">:</td>
