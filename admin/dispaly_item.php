...
function search_product(page){
	$('#product_div').load("search_products.php",{'service':$('#service').val(),'code':$('#code').val(),'page':page});
}

function delete_product(p_id){
	if(confirm("Do you want to delete product?")){
		window.location='delete_product.php?p_id='+p_id;
	}
}
</script>
<!-- InstanceEndEditable -->
                    ...
                    <table width="740" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr class="body_text">
                        <td align="center" class="rounded-corners"><table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr class="body_text">
                            <td height="25" colspan="6" align="left" class="page_title_text">SEARCH PRODUCTS</td>
                          </tr>
                          <tr class="body_text">
                          ...
                          <tr class="body_text">
                            ...
                            <td width="255" align="left"><input name="service" type="text" class="body_text" id="service" size="30" /></td>
                          ...
                          <tr class="body_text">
                            ...
                            <td align="center">:</td>
                            <td align="left"><input name="code" type="text" class="body_text" id="code" size="30" /></td>
                            <td align="left">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="left">&nbsp;</td>
                          </tr>
