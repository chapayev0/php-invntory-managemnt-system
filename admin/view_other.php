...
$user_type=$_SESSION['user_type'];
	...
	$query_stu="SELECT * FROM tbl_other WHERE v_id='".$_REQUEST['v_id']."' AND v_status='0'";
	
	
	
	$result_stu=mysqli_query($connection,$query_stu) or die("Unable to select data from the tbl_reciept. ".mysqli_error());
          ...
          <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="rounded-corners"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr class="body_text">
                  <td height="25" colspan="4" align="center" class="page_title_text"><p>VIEW VEHICLES</p></td>
                </tr>
               
                <tr class="body_text">
                  <td width="125" height="25" align="center">Name</td>
                  <td width="20" align="center">:</td>
                  <td width="255" align="left"><?php echo $row_stu["v_name"]; ?></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="center">Owner</td>
                  <td align="center">:</td>
                  <td align="left"><?php echo $row_stu["own"]; ?></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="center">Date</td>
                  <td align="center">:</td>
                  <td align="left"><?php echo $row_stu["date"]; ?></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="center" >Chasy No</td>
                  <td align="center">:</td>
                  <td align="left"><?php echo $row_stu["chasy"]; ?></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="center" >Description</td>
                  <td align="center">:</td>
                  <td align="left"><?php echo $row_stu["des"]; ?></td>
                </tr>
                <tr class="body_text">
                  <td height="25" align="center" >Engine No</td>
                  <td align="center">:</td>
                  <td align="left"><?php echo $row_stu["eng"]; ?></td>
                </tr>
              </table></td>
            </tr>
          </table>
