...
function edit_category(div_id,cat_name,cat_id){
	$('#'+div_id).load("edit_rute.php",{'cat_name':cat_name,'cat_id':cat_id});
}
                      ...
                      <td height="20" colspan="2" align="left"><div id="cat_div_<?php echo $count; ?>">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr class="body_text" onmouseover="this.style.backgroundColor='#EDFBD9';" onmouseout="this.style.backgroundColor='';">
                            <td width="350" height="20" align="left" class="border_bottom_left" style="padding-left:3pt;"><?php echo $row_cat["r_name"]; ?></td>
                            <td width="50" align="center" class="border_bottom_left_right"><img src="../images/edit.png" alt="" width="10" height="10" style="cursor:pointer" onclick="edit_category('cat_div_<?php echo $count; ?>','<?php echo $row_cat["r_name"]; ?>','<?php echo $row_cat["r_id"]; ?>');"/></td>
                          </tr>
                        </table>
                      </div></td>
                    </tr>
