      ...
      <tr>
        ...
        <form action="add_student.php" method="post" name="student_form" id="student_form" enctype="multipart/form-data" onsubmit="return student_validation();">
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="body_text">
              <td height="25" colspan="3" align="left" class="page_title_text">KAPUWA REGISTRATION</td>
              </tr>
            <tr class="body_text">
            ...
            <tr class="body_text">
              ...
              <td align="center">:</td>
              <td align="left"><input name="nic2" type="text" class="body_text" id="nic2" size="15" /></td>
            </tr>
            <tr class="body_text">
            ...
            <tr class="body_text">
              ...
              <td align="left"><textarea name="address" cols="35" rows="3" class="body_text" id="address"></textarea></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">&nbsp;</td>
              <td align="center">&nbsp;</td>
              <td align="left" class="green_text"><img src="../images/add.gif" width="65" height="35" id="add" style="cursor:pointer" onclick="form_submission('add','student_form');"/> <img src="../images/clear.gif" width="65" height="35" style="cursor:pointer" onclick="reset_form('student_form');"/></td>
            </tr>
          </table>
          </form>
          </td>
